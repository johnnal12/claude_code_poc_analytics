      ...
      <div className="h-72">
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={top} layout="vertical" margin={{ top: 4, right: 4, left: 0, bottom: 0 }} barGap={2}>
            <CartesianGrid strokeDasharray="3 3" className="stroke-warm-200/60 dark:stroke-warm-800/60" horizontal={false} />
            <XAxis type="number" tick={{ fontSize: 11 }} className="text-stone-400" tickLine={false} axisLine={false} />
            <YAxis dataKey="name" type="category" tick={{ fontSize: 11 }} className="text-stone-400" tickLine={false} axisLine={false} width={120} />
            <Tooltip
